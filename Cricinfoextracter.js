...
// minimist -> to take data from the command line to args
let minimist = require("minimist");

// axios -> reads data from the source i.e from cricinfo
let axios = require("axios");

// jsdom -> process data from the source i.e get all teams
let jsdom = require("jsdom");

// excel4node -> makes excel file of the data
let excel4node = require("excel4node");

// pdf-lib -> makes pdf of the data in teams folder
let pdf = require("pdf-lib");

// fs -> use to read file 
let fs = require("fs");

// pth -> joins path of file looking at the slashes 
let path = require("path");

// browser => url to html (url se http request -> server ne html in http response)
// parse args from cmdline via minimist
